...
constructor(
  ...
  constructor(
    ...
    private val targetName: String = named
  ...
  constructor(
    ...
    val generatorTask: TaskProvider<GenerateNativeBenchmarkTask> =
      project.tasks.register<GenerateNativeBenchmarkTask>(
        ...
        this.targetName.convention(this@KotlinNative.targetName)
        this.title.convention(this@KotlinNative.title)
      }
  }

  abstract class KotlinJs
  @KotlinxBenchmarkPluginInternalApi
  @Inject
  constructor(
    named: String,
  ...
  constructor(
    ...
    val generatorTask: TaskProvider<GenerateWasmBenchmarkTask> =
      project.tasks.register<GenerateWasmBenchmarkTask>(
        ...
        title.convention(this@KotlinWasmJs.title)
      }
  }

  abstract class KotlinWasmWasi
  @KotlinxBenchmarkPluginInternalApi
  @Inject
  constructor(
    named: String
